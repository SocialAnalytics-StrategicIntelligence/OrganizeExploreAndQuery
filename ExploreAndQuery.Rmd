...
```{r}
rm(list = ls())
denguelink='https://github.com/SocialAnalytics-StrategicIntelligence/OrganizeExploreAndQuery/raw/main/dataFiles/ByProvinceWeek_AllCases.pkl'

library(reticulate)
# py_install("pandas")
pd <- import("pandas")
dengue <- pd$read_pickle(denguelink)
